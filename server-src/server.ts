...
const AppServerModuleNgFactory = require('../dist-server/main.f80cb506d9d3a3a2248a.bundle.js').AppServerModuleNgFactory; // bundle name set by npm script build-set-server-main-bundle
